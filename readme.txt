...
Replaces the author link with your Google+ Profile Link, adds a special link after every blogpost or adds a special meta tag in your websites HTML header.

== Description ==

<strong>Note that Google no longer shows authorship information on search results. Due to this fact I will no longer update this plugin.</strong>
...
Just make a copy of the gpaisr.po file (which you can find in the /lang/ folder of the plugin) and translate it using a translation tool like [PoEdit](http://poedit.net).

Translations:

* de_DE by Flow @ [WP-Buddy](http://wp-buddy.com)
* es_ES by Andrew @ [WebHostinghub](http://www.webhostinghub.com)
...
= 0.7.4 =
* Added es_ES translation. Thanks to Andrew @ [WebHostinghub](http://www.webhostinghub.com)
